...
export default function FilterPanel({ onDataLoaded, onFiltersChange, filters, years: propYears }: FilterPanelProps) {
  ...
  const displayYears = propYears || apiYears?.map(y => y.toString()) || [];
